...
import { BackstageIcon } from './components/Icons.jsx';
import { useChat } from './hooks/useChat.js';
import { useOperatorEvents } from './hooks/useOperatorEvents.js';
import { getState, getProducts, post } from './lib/api.js';
import { naira, firstLine } from './lib/format.js';
...
export default function App() {
  ...
  const onToggleGuardrails = useCallback((next) => {
    post('/api/control/guardrails', { on: !!next });
  }, []);
  const onToggleCached = useCallback((next) => {
  ...
  const onScript = useCallback(async (n) => {
